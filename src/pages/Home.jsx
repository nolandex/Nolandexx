  ...
  const pricingPlans = [
    {
      ...
      monthlyPrice: 99,
      yearlyPrice: 990,
      description: "Perfect for growing businesses seeking advanced AI solutions.",
      features: [
    ...
    },
    {
      ...
      yearlyPrice: 4990,
      description: "Tailored for large-scale organizations with custom AI needs.",
      features: [
      ...
      <section id="home" className="min-h-screen flex items-center relative z-10 pt-32 pb-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <div id="pricing" className="mt-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-center">Our Pricing</h2>
